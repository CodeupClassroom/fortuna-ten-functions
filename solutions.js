...
function addOne(num) {
    ...
    // var returnString = "Your number plus 1 = " + (userNum + 1);
    return ("Your number plus 1 = " + (userNum + 1)); // return userNum + 1 is cleaner code  // our return value will be userInput + 1
    // return returnString;
}
