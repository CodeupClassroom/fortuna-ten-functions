...
function addOne(input) {     //fix
    if (0 !== isNaN || typeof "input" === "string"){
        return ((input) + 1);
    }
}
...
function isEqual(argumentOne, argumentTwo){
...
function or(inputArgumentOne, inputArgumentTwo){
    return inputArgumentOne || inputArgumentTwo;
}
...
function concat(argumentOne, argumentTwo) {
    // var argumentOne = typeof "argumentOne";
    // var argumentTwo = typeof "argumentTwo";
 return argumentOne.concat(argumentTwo);
}